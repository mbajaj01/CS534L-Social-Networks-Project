...
def plot_curves2(file1,file2,file3,name):
	...
	randoml1 = randoml1[0:len(iterations)]
	highdegl1 = highdegl1[0:len(iterations)]
	...
	plt.plot(iterations,randoml1,'*-')
	plt.plot(iterations,highdegl1,'2-')
	plt.grid(True)
...
# Node level nethept
file1 = 'log_1.000000graph_ic.inf' # seems like mohit has named the files wrong
file2 = 'log_0.500000graph_ic.inf' # so I have swapped his explore and exploit
file3 = 'log_0.000000graph_ic.inf'
